import type { DataStream, Process } from "../Process.svelte";
...
export class SveltePTY extends PTYBase {
  ...
  public handleStdout(data: DataStream, proc: Process): void {
  ...
  public handleExit(code: number, proc: Process): void {}
}
